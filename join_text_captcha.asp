...
<%
if vJoin <> "" AND request.Form("Submit") <> "" AND len(request("imagecheck"))>0 AND ucase("" & request("imagecheck")) = ucase("" & session("checktext")) AND gazzabazza2.EOF then
...
<br>
                              ...
                              <div align="center">
                                <div align="center">
                                 ...
                                 <input name="" type="hidden" value="<%=vJoin%>">
	                          			  ...
	                          			  <%
											session("checktext") = RandomText(3)
										  %>
								    

									      <%
											if len(request("imagecheck"))>0 then response.write "<br><span class='linkcontact2'><font size='2'><b> Has debido escribir mal la prueba de humanidad <br>(o eso o eres un replicante).<br>Inténtalo de nuevo o pulsa F5 si encuentras algún problema.</b></font></span><br>"
											
											%>
														
      
											<br>
								                <span class="contact"><strong>Eres humano?<br>
									         Pru&eacute;balo !</strong>
                                  </span><br /> 
											 ...
											 <img alt="Human image test" src="captcha/generate-captcha.asp" border="0"/>
                                               ...
                                               <%
											if len(request("imagecheck"))>0 then response.write "<span class='linkcontact2'><font size='1'><br>Si tienes algún problema<br> para leer o escribir lo que está encima <b>presiona F5</b></font><br></span>"
      ...
      <br>
			El Azar Manda<span class="barre">&nbsp;<font size="2">&copy;</font>&nbsp;</span> G&amp;B 2009<br>
			:::<strong><a href="about.asp">&nbsp; Sobre G&amp;B</a></strong>&nbsp; ::: <a href="http://translate.google.com/translate_t#" target="_blank">Traductor</a> ::: <a href="contact.asp">Contacta</a> :::<br>
			</span><br>
