...
'objCDOMail.To = "danicotillas@yahoo.es"
	...
	vMessage =  vNombre & " has contacted with G&B to say: " &"<br><br>"&  vMessages
...
<div class="container">
				      ...
				      o preguntame lo que te parezca</font></font></strong> 
					    <div align="center">
				            <%
  if vNombre <> "" AND request.form("email") <> "" AND vSubject <> ""AND vMessages <> ""then
   %>
  ...
  %>
  <form action="contact_2.asp" method="post" Nombre="form1" id="form1" onSubmit="MM_validateForm('Nombre','','R','email','','RisEmail','Subject','','R','Message','','R');return document.MM_returnValue" >
<table width="85%" height="100%" border="0" align="center">
                            ...
                            <tr>
                              ...
                              <td width="225" valign="top"><input Nombre="Nombre" type="text" id="Nombre" /></td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
...
<br />
                              ...
                              <td valign="top"><input Nombre="email" type="text" id="email" value="Email por favor" />                              </td>
                            </tr>
                            <tr>
                              <td height="32">&nbsp;</td>
                              <td valign="top"><span class="contact"><strong>&iquest;Porqu&eacute;?</strong> </span><span class="Estilo5"><br />
                              </span></td>
                              <td valign="top"><input Nombre="Subject" type="text" id="Subject" /></td>
                            </tr>
                            <tr>
                              <td height="103">&nbsp;</td>
                              <td valign="top" class="contact"><strong>&iquest;Qu&eacute;?</strong></td>
                              <td valign="top"><textarea Nombre="Message" rows="10" id="Message" ></textarea>                              </td>
                            </tr>
                            <tr>
                              <td>&nbsp;</td>
                              <td>&nbsp;</td>
                              <td><label>
                                <input Nombre="Enviar" type="submit" id="Enviar" value="Dale!" />
                              </label></td>
                            </tr>
        </table>
					    </form>
