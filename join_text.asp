...
ObjSendMail.To = "danicotillas@gmail.com"
ObjSendMail.Subject = "TEXTO en Gazza&Bazza"
ObjSendMail.From = "info@gazzabazza.net"
 

ObjSendMail.TextBody = "Nuevo texto en la web: <br><br> <b> "& vJoin &" </b>"
...
function MM_validateForm() { //v4.0
  ...
  for (i=0; i<(args.length-2); i+=3) { test=args[i+2]; val=MM_findObj(args[i]);
    ...
    } } } else if (test.charAt(0) == 'R') errors += ' ¿Qu&#65533;? ¿No vas a escribir nada?\n'; }
...
%>
			 <p class="linkcontact2"><strong>¿Te creías original?<br>
			   ...
			   Este texto ya se le ocurri&#65533; a alguien antes.<br>
 ...
 <%else%>          
           ...
           <%if vJoin <> "" AND request.Form("Submit") <> "" AND gazzabazza2.EOF then%> 
	                          ...
	                          <br>
	                          ha sido incluido con ¨¦xito!<br>
	                          </span>
                              <br>
                              <span class="texto"><span class="Estilo4">Gracias !</span></span><br>
<br>

                               <p class="linkcontact2"><strong>Espera un segundo y contin¨²a!</strong>			   </p>
